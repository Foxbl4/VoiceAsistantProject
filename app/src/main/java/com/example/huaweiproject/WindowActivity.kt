...
class WindowActivity(private val context: Context) {

    private val windowManager = context.getSystemService(Context.WINDOW_SERVICE) as WindowManager
    private val layoutInflater = context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
    private val rootView = layoutInflater.inflate(R.layout.over_main_activity, null)
    ...
    private fun initWindow() {
        ...
        rootView.findViewById<View>(R.id.content_button).setOnClickListener {
            val textView: TextView = rootView.findViewById<View>(R.id.content_text) as TextView
            textView.text = "I'm still here!"
        }
    }
